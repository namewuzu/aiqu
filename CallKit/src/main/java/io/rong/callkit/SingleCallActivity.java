...
public class SingleCallActivity extends BaseCallActivity implements Handler.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        times =  intent.getIntExtra("TIME",0);
...
//        }
    ...
    public void onCallConnected(RongCallSession callSession, SurfaceView localVideo) {
        ...
        FinLog.v(TAG, "onCallConnected----callSession=" + callSession);
        FinLog.v(TAG, "onCallConnected----callSession.getActiveTime=" + callSession.getActiveTime());
...
//                userName.setShadowLayer(16F, 0F, 2F, getResources().getColor(R.color.rc_voip_reminder_shadow));//callkit_shadowcolor
        ...
        if (callSession.getActiveTime()>=10000) {
            showShortToast("在线");
        }
        stopRing();
...
//            mConnectionStateTextView.setVisibility(View.GONE);
    ...
    public void onHangupBtnClick(View view) {
        ...
        FinLog.e(TAG, "时间" + getTime());
        payCoin(session.getCallerUserId(),new Long(getTime()).intValue());
    }
