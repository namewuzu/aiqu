package com.example.administrator.hjproject.widget.pagemanage;
...
public class PageManager {
    ...
    public static PageManager init(final Object container, boolean isShowLoadingOrContent, final Runnable retryAction) {
        final PageManager manager = generate(container, new PageListener() {
            @Override
    ...
    public View setCustomLoadingView(View view) {
        return mLoadingAndRetryLayout.setLoadingView(view);
    }

    public View setCustomRetryView(View view) {
        return mLoadingAndRetryLayout.setRetryView(view);
    }

    public View setCustomEmptyView(View view) {
        return mLoadingAndRetryLayout.setEmptyView(view);

    }

    public View setCustomLoadingLayoutId(int layoutId) {
        return mLoadingAndRetryLayout.setLoadingView(layoutId);
    }

    public View setCustomRetryLayoutId(int layoutId) {
        return mLoadingAndRetryLayout.setRetryView(layoutId);
    }

    public View setCustomEmptyLayoutId(int layoutId) {
        return mLoadingAndRetryLayout.setEmptyView(layoutId);
    ...
    public void showNoNetError() {
        mLoadingAndRetryLayout.setCurrentRetryMessageViewLayout(R.mipmap.ic_loading_no_net, "没有网络,请检查网络情况");
    }
    ...
    public void setEmptyLayoutParam() {
        ...
        params.topMargin = DisplayUtil.px2dip(15);
