...
import com.diankong.sexstory.mobile.databinding.ActivityUserDetailListBinding;
...
public class UserDetailListViewModle extends BaseViewModle<ActivityUserDetailListBinding>implements RecyclerArrayAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initUI() {
        ...
        mMyAdapter = new CircleAdapter(act,type,act);
    ...
    private void getListData() {
        EasyHttp.get(Api.apiurl2 + "community/selelctCommunitysPageByUserId")
