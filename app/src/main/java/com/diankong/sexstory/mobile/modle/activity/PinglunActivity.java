...
import com.diankong.sexstory.mobile.modle.modelview.PinglunViewModle;
...
public class PinglunActivity extends BaseAct<ActivityPinglunBinding,PinglunViewModle> {
    @Override
