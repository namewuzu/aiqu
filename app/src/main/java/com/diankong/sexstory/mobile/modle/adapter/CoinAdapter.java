...
import com.diankong.sexstory.mobile.modle.viewholder.CoinViewHolder;
...
public class CoinAdapter extends RecyclerArrayAdapter<CoinPojo> {
    ...
    public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
        return new CoinViewHolder(parent);
    }
}
