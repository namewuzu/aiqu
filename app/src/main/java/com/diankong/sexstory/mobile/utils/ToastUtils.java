...
//        }
        ...
        View view = LayoutInflater.from(App.getInstance()).inflate(R.layout.toast_custom_tv, null);
...
//        toast.show();
    ...
    public static void showShort(CharSequence message) {
        ...
        else Toast.makeText(App.getContext(), message, Toast.LENGTH_SHORT).show();
...
//		Toast.makeText(context, strResId, Toast.LENGTH_SHORT).show();
        ...
        else Toast.makeText(App.getContext(), strResId, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void show(CharSequence message, int duration) {
        ...
        else Toast.makeText(App.getContext(), message, duration).show();
    }
...
/**
    ...
    public static Toast showToastWithImg(String tvStr) {
        ...
        return showToastWithImg(tvStr, R.mipmap.ic_wdqy_pj_bumanyi);
    }
*/
