...
import com.diankong.sexstory.mobile.modle.modelview.SettingViewmodle;
 ...
 * =============================================
 */
public class SettingActivity extends BaseAct<ActivitySettingBinding, SettingViewmodle> {
    @Override
