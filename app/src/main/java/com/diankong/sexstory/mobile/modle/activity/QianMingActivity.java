...
import com.diankong.sexstory.mobile.modle.modelview.QianMingViewModle;
...
public class QianMingActivity extends BaseAct<ActivityQianmingBinding,QianMingViewModle> {
    @Override
