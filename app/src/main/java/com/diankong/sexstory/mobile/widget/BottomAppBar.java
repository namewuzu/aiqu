 ...
 * 作者：Created by 胡清 on 2018/12/10.
 * 描述：
 * =============================================
 */
...
public class BottomAppBar extends LinearLayout {
     ...
     * @return
     */
    public BottomAppBar addItem(final String title, Drawable drawable, Fragment fragment, boolean redPoint) {
     ...
     * @return
     */
    public BottomAppBar setTextToImgSize(int dp) {
        for (TextView itemTextView : itemTextViews) {
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            layoutParams.setMargins(0,0,0,dp);//4个参数按顺序分别是左上右下
    ...
    public void showRedPoint(int... show)  {
        for (int i = 0; i < show.length; i++) {
            ...
            if (imageView!=null) {
                ...
                L.e("BottomBar","Not founded fragment");
            }
        }
    }
