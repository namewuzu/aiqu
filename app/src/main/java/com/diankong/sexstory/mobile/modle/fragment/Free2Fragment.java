...
import com.diankong.sexstory.mobile.databinding.FragmentFree2Binding;
import com.diankong.sexstory.mobile.http.Api;
import com.diankong.sexstory.mobile.modle.modelview.Free2ViewModle;
...
public class Free2Fragment extends BaseFrag<FragmentFree2Binding,Free2ViewModle>{
    ...
    public static Free2Fragment newInstance(int type) {
        Bundle args = new Bundle();
        args.putInt("TYPE", type);
        Free2Fragment fragment = new Free2Fragment();
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_free2;
    }
...
//    }
    ...
    private void initWB() {
        ...
        //打开的网址
        b.webview.loadUrl("http://a123.lctfrx.cn/index2/scdial.html?userId=" + SpUtlis.getId());
//        if (type==1) {
//            b.webview.loadUrl("http://47.244.153.104/index2/scCountDown.html?userId=" + SpUtlis.getId());
//        }else{
//
//        }
