...
import com.diankong.sexstory.mobile.modle.modelview.ChatStartViewModle;
...
public class ChatStartActivity extends BaseAct<ActivityChatStartBinding,ChatStartViewModle> {
    @Override
