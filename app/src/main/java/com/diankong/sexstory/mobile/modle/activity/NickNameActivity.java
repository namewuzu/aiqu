...
import com.diankong.sexstory.mobile.modle.modelview.NickNameViewModle;
...
public class NickNameActivity extends BaseAct<ActivityNicknameBinding,NickNameViewModle> {
    @Override
